    ...
    public static int login () {
        ...
        while (order_again) {
            ...
            if (answer.equalsIgnoreCase("y")) {
                ...
                else if  (!choice.equalsIgnoreCase("d") & !choice.equalsIgnoreCase("t")) {
                	System.out.println("Invalid input, please try again. \n");
                }
    	...
    	public static int payment () {
    		do {
    			do {
    				...
    				else if (!mop.equals("Cash") & !mop.equals("Credit/Debit Card") & !mop.equals("Mobile Wallet")) {
    					System.out.println("Invalid input, please try again.\n");
    					loop = true;
    				} 
    			} while (loop);
